      ...
      <div className="bg-white py-7 px-8 space-y-14 rounded-3xl lg:py-10 lg:px-16">
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="flex flex-col gap-3 md:justify-between md:flex-row">
            <div className="space-y-2">
              ...
              <p className="text-base text-black opacity-70">
                Your plan renews on January 02, 2022
              </p>
            </div>
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="flex items-center gap-x-4">
            ...
            <p className="text-base text-black opacity-70 md:pr-12 lg:text-lg">
              4242 **** **** 5816
            </p>
            <DefaultBtn />
          </div>
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="flex items-center gap-x-6 md:gap-x-12">
            ...
            <p className="text-base text-black opacity-90 lg:text-lg">
              user@email.com
            </p>
          </div>
        ...
        <div className="space-y-2 md:space-y-3 pb-5 md:pb-7 lg:pb-9">
          ...
          <div className="bg-[#F2F5FF] flex items-center gap-x-6 p-4 rounded-2xl lg:p-8">
            <div
              ...
              className="size-8 bg-white rounded-full border-1 border-[#DADADA]"
            >
              {isCheck ? (
                <FaCheckCircle className="size-8 text-[#4169E1]" />
              ) : null}
            </div>
